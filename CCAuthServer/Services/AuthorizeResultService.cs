    ...
    public class AuthorizeResultService : IAuthorizeResultService
    {
        ...
        public TokenResponse GenerateToken(IHttpContextAccessor httpContextAccessor)
        {
            ...
            if (clientCodeChecker.IsOpenId)
            {
                ...
                id_token = new JwtSecurityToken("https://localhost:7092", request.ClientId, claims, signingCredentials: credentials,
            ...
            var access_token = new JwtSecurityToken("https://localhost:7092", request.ClientId, claims_at, signingCredentials: credentials_at,
                expires: DateTime.UtcNow.AddMinutes(
                   int.Parse("5")));
