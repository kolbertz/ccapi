...
public class Program
{
    private static void Main(string[] args)
    {
        ...
        builder.Services.AddSwaggerGen(c => {
            ...
            {
                Title = "CashControl ProductPrice Service Version 2",
                Description = "This is an CashControl ProductPrice Service with Dapper ORM Mapper"
            });
            c.EnableAnnotations();
        ...
        .AddJwtBearer("monolithAuth", options =>
        {
            ...
            options.Authority = "http://localhost:7116";
