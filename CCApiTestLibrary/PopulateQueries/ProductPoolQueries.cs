...
namespace CCApiTestLibrary.PopulateQueries
{
    ...
    {
         public static string PopulateSingleProductPool(int key = 1, string name = "Test")
         {
            return "INSERT INTO ProductPool(ProductPoolKey, [Name], SystemSettingsId, CreatedDate, CreatedUser, LastUpdatedDate, LastUpdatedUser) " +
                "OUTPUT Inserted.Id " +
                $"VALUES({key}, '{name}', 'fab8c985-6147-4eba-b2c7-5f7012c4aeeb', GetDate(), '1f11e600-4b51-4ae5-9feb-d372d096acb4', GetDate(), '1f11e600-4b51-4ae5-9feb-d372d096acb4')";
         }
